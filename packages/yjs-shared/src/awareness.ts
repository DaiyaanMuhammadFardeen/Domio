...
export const CURSOR_PALETTE: readonly string[] = [
  '#E64B35', '#4E79A7', '#59A14F', '#EDC948', '#B07AA1',
  '#FF9DA7', '#9C755F', '#BAB0AC', '#76B7B2', '#FF6F3F',
  '#6A9CD9', '#86BCB6', '#A0CBE8', '#F1CE63', '#D4A6C8',
  '#FF968A', '#B69992', '#D7B5A3', '#499894', '#E15759',
  '#F28E2B', '#79706E', '#C5B4E3', '#AF7AA1', '#FFBDAF',
  '#D37295', '#9D7660', '#FABFD2', '#A3C4BC', '#DEB5A0',
  '#8CD17D', '#F4D03F', '#48B8D0', '#EB5757', '#8E6BB0',
  '#CAB8D9', '#AEC7D8', '#FF7F0E', '#1F77B4', '#2CA02C',
  '#D62728', '#9467BD', '#8C564B', '#E377C2', '#7F7F7F',
  '#BCBD22', '#17BECF', '#393B79', '#637939', '#8C6D31',
  '#843C39', '#7B4173', '#5254A3', '#B5CF6B', '#CEDB9C',
  '#E7BA52', '#E7CB94', '#DE9ED6', '#C49C94', '#F7B6D2',
  '#C7E7C3', '#DEBC99', '#C7C7C7', '#798E9E',
] as const;
 ...
 */
export function deterministicCursorColor(
  userId: string,
