...
describe('attendance-logger', () => {
  ...
  it('records join + leave, computes summary', async () => {
    const join = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-1',
      joined_at_ms: 1000,
    ...
    const leave = await svc.recordLeave({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-1',
      left_at_ms: 6000,
  ...
  it('chains participants in arrival order', async () => {
    const a = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-1',
      joined_at_ms: 1000,
    });
    const b = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-2',
      joined_at_ms: 1100,
    });
    const c = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-3',
      joined_at_ms: 1200,
  ...
  it('isolates chains per (workspace, session)', async () => {
    const a1 = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-1',
      joined_at_ms: 1000,
    });
    const a2 = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's1',
      participant_id: 'u-2',
      joined_at_ms: 1100,
    });
    const b1 = await svc.recordJoin({
      workspace_id: 'w1',
      session_id: 's2',
      participant_id: 'u-1',
      joined_at_ms: 1500,
