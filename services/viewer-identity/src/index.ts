...
export { evaluateMode, defaultPolicyFor, CURRENT_POLICY_VERSION, ipClassFor } from './consent/policy.js';
export { eraseViewer, exportViewer, objectToTracking, GdprError } from './gdpr/handlers.js';
export { buildIdentityMirror, NullIdentityMirror, type IdentityMirror, type IdentityMirrorClient } from './mirror/index.js';
export type { PrivacyMode, Region, IdentityConfig, ViewerRecord, IdentityLink, ConsentEvent } from './types.js';