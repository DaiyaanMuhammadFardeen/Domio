...
describe('nav-vote-collector', () => {
  ...
  it('collects votes and tallies', async () => {
    await collector.cast({ workspace_id: 'w1', session_id: 's1', slide_id: 'sl-1', participant_id: 'u-1', direction: 'next', idempotency_key: 'k1' });
    await collector.cast({ workspace_id: 'w1', session_id: 's1', slide_id: 'sl-1', participant_id: 'u-2', direction: 'next', idempotency_key: 'k2' });
    await collector.cast({ workspace_id: 'w1', session_id: 's1', slide_id: 'sl-1', participant_id: 'u-3', direction: 'previous', idempotency_key: 'k3' });
