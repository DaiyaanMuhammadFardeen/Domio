 ...
 */
import type { AnnotationCommitInput, AnnotationCommitResult, AnnotationGeometry, AnnotationLayerRecord, AnnotationPromoteInput, AnnotationRollbackInput } from './types.js';
...
export declare class AnnotationService {
     ...
     */
    commit(input: AnnotationCommitInput, ctx: {
        actorId: string;
    ...
    rollback(input: AnnotationRollbackInput, ctx: {
        actorId: string;
    }): Promise<void>;
    /** Promote an ephemeral annotation to a saved overlay attached to the slide. */
    promote(input: AnnotationPromoteInput, ctx: {
        actorId: string;
