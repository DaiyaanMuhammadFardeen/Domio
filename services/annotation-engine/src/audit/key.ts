...
export function deriveAuditKey(rootKey: string, workspaceId: string): Buffer {
...
export class StaticAuditKeyResolver implements AuditKeyResolver {
  constructor(private readonly root: string) {}
  async rootKey(): Promise<string> {
    return this.root;
  }
}
