 ...
 */
import { AnnotationConflictError, AnnotationNotFoundError, AnnotationValidationError, } from './types.js';
...
export class AnnotationHandlers {
    ...
    commit = async (req) => {
        ...
        if (!sessionId)
            return mapDomainError(new AnnotationValidationError('sessionId required'));
        ...
        try {
            ...
            if (req.body.layer_id !== undefined)
                commitInput.layer_id = req.body.layer_id;
            if (req.body.style !== undefined)
                commitInput.style = req.body.style;
            if (req.body.color !== undefined)
                commitInput.color = req.body.color;
            if (req.body.stroke_width !== undefined)
                commitInput.stroke_width = req.body.stroke_width;
            if (req.body.ephemeral !== undefined)
                commitInput.ephemeral = req.body.ephemeral;
            ...
            if (req.idempotencyKey !== undefined)
                commitInput.idempotency_key = req.idempotencyKey;
