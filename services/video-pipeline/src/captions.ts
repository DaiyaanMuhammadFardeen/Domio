...
export const SAMPLE_WAVEFORM_SAMPLES: readonly number[] = [
  0.12, 0.34, 0.56, 0.78, 0.9, 0.45, 0.23, 0.67, 0.89, 0.11, 0.33, 0.55, 0.77, 0.99, 0.88, 0.66,
  0.44, 0.22, 0.1, 0.3, 0.5, 0.7, 0.91, 0.73, 0.53, 0.35, 0.15, 0.85, 0.65, 0.43, 0.21, 0.95, 0.75,
  0.57, 0.39, 0.18, 0.82, 0.62, 0.42, 0.25, 0.08, 0.92, 0.72, 0.52, 0.32, 0.14, 0.86, 0.68,
];
