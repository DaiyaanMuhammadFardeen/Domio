...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@domio/deep-link': resolve(here, '../../packages/deep-link/src/index.ts'),
      '@domio/schema': resolve(here, '../../packages/schema/src/index.ts'),
      '@domio/schema/generated/scene-graph': resolve(
        here,
        '../../packages/schema/src/generated/scene-graph.ts',
      ),
      ...
      '@bufbuild/protobuf': resolve(
        here,
        '../../node_modules/.pnpm/@bufbuild+protobuf@1.10.1/node_modules/@bufbuild/protobuf',
      ),
    },
  },
  test: {
