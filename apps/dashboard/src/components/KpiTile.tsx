...
export interface KpiTileProps {
  title: string;
  value: string;
  delta?: number; // percent change; positive = up, negative = down
  deltaSuffix?: string;
  sparkline?: ReactNode;
...
/**
 * A single KPI tile. Renders a title, big value, and a delta arrow
 * tinted by sign. A sparkline slot is provided so callers can drop
 * in the @domio/chart `<Sparkline />` primitive.
 */
