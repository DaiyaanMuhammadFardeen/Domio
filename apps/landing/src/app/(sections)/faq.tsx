...
export function Faq(): JSX.Element {
  return (
    <section className="faq-section" aria-labelledby="faq-heading" data-testid="faq-section">
      <header className="faq-section__header">
        ...
        <p className="faq-section__lede">
          Don&rsquo;t see what you&rsquo;re looking for? <a href="/contact">Drop us a line</a>.
        </p>
      </header>
