...
/**
 * Generic sortable table primitive. Numeric columns sort numerically;
 * string columns use locale-aware comparison. Toggles between asc/desc
 * on repeated header clicks; a third click clears the sort.
 */
            ...
            {columns.map((c) => {
              ...
              return (
                <th
                  ...
                  scope="col"
                  className={clsx(
                    'select-none px-4 py-2 text-xs font-semibold uppercase tracking-wider text-slate-600',
                ...
                {columns.map((c) => {
                  ...
                  return (
                    <td
                      key={c.key}
                      className={clsx(
                        'whitespace-nowrap px-4 py-2 text-slate-800',
