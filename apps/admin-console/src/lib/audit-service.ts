...
const EVENT_SPECS: ReadonlyArray<EventSpec> = [
  // Day -0 (today) — recent, freshest
  {
    ...
    target_type: 'user',
    target_id: 'u-alice',
    metadata: { ip: '10.0.0.4', user_agent: 'Chrome/127' },
  },
  {
    days_ago: 0,
    hour: 9,
    ...
    target_type: 'deck',
    target_id: 'd-001',
    metadata: { tenant_id: 'acme', slides: 12 },
  },
  {
    days_ago: 0,
    hour: 9,
    ...
    target_type: 'deck',
    target_id: 'd-001',
    metadata: { visibility: 'link', recipient_count: 3 },
  },
  {
    days_ago: 0,
    hour: 10,
  ...
  },
  {
    ...
    minute: 17,
    actor_id: 'u-bob',
    action: 'sso.test-login',
    target_type: 'sso-provider',
    target_id: 'sso-okta-acme',
    metadata: { ok: true, latency_ms: 412 },
  },
  {
    days_ago: 0,
    hour: 10,
    minute: 38,
    actor_id: 'svc-trust-scanner',
    action: 'deck.deleted',
    target_type: 'deck',
    target_id: 'd-old-991',
    metadata: { reason: 'trust_below_threshold', score: 12 },
  },
  {
    days_ago: 0,
    hour: 11,
    minute: 5,
    actor_id: 'u-carol',
    action: 'dlp.rule.updated',
    target_type: 'dlp-rule',
    target_id: 'dlp-ssn',
    metadata: { scopes_changed: 1 },
    diff: {
      before: { enabled: true, scopes: ['comment'] },
      after: { enabled: true, scopes: ['comment', 'slide-content'] },
    },
  },
  {
    days_ago: 0,
    ...
    target_type: 'webhook',
    target_id: 'wh-77',
    metadata: { url: 'https://acme.com/hooks/deck', events: 4 },
  },
  {
    days_ago: 0,
    hour: 11,
    minute: 47,
    actor_id: 'sys-housekeeping',
    action: 'residency.changed',
    target_type: 'residency',
    target_id: 'res-eu-west',
    metadata: { region: 'eu-west-1', from: 'us-east-1', to: 'eu-west-1' },
  },
  {
    days_ago: 0,
    hour: 12,
    ...
    target_type: 'apikey',
    target_id: 'ak-201',
    metadata: { scope: 'read', prefix: 'pk_live_a8f3' },
  },
  ...
  },
  {
    ...
    minute: 15,
    actor_id: 'u-alice',
    action: 'deck.exported',
    target_type: 'deck',
    target_id: 'd-001',
    metadata: { format: 'pdf', size_kb: 1840 },
  },
  {
    days_ago: 1,
    hour: 8,
  ...
  },
  {
    ...
    minute: 38,
    actor_id: 'u-erin',
    action: 'sso.provider.added',
    target_type: 'sso-provider',
    target_id: 'sso-azure-stark',
    metadata: { protocol: 'oidc' },
    diff: { before: null, after: { name: 'Azure AD (stark)', protocol: 'oidc' } },
  },
  {
    days_ago: 1,
    hour: 10,
    ...
    target_type: 'sso-provider',
    target_id: 'sso-azure-stark',
    metadata: { ok: false, latency_ms: 1203, error: 'invalid_signature' },
  },
  {
    days_ago: 1,
    hour: 10,
    minute: 47,
    actor_id: 'svc-legal-bot',
    action: 'legal-hold.applied',
    target_type: 'legal-hold',
    target_id: 'lh-12',
    metadata: { scope: 'deck', reason: 'preservation_request', case_id: 'CR-2026-441' },
  },
  {
    days_ago: 1,
    hour: 11,
  ...
  },
  {
    ...
    minute: 9,
    actor_id: 'u-carol',
    action: 'dlp.rule.added',
    target_type: 'dlp-rule',
    target_id: 'dlp-credit-card',
    metadata: { kind: 'entity', entity: 'credit_card' },
  },
  {
    days_ago: 1,
    hour: 14,
    ...
    target_type: 'webhook',
    target_id: 'wh-31',
    metadata: { reason: 'endpoint_410' },
  },
  {
    days_ago: 1,
    hour: 15,
    minute: 56,
    actor_id: 'svc-payout-runner',
    action: 'deck.deleted',
    target_type: 'deck',
    target_id: 'd-stale-204',
    metadata: { reason: 'soft_delete_30d' },
  },
  {
    days_ago: 1,
    hour: 16,
  ...
  },
  {
    ...
    target_type: 'deck',
    target_id: 'd-002',
    metadata: { tenant_id: 'acme', slides: 18 },
  },
  {
    days_ago: 2,
    hour: 8,
  ...
  },
  {
    ...
    minute: 12,
    actor_id: 'u-carol',
    action: 'dlp.rule.deleted',
    target_type: 'dlp-rule',
    target_id: 'dlp-old-ssn',
    metadata: { reason: 'replaced_by_dlp-ssn' },
  },
  {
    days_ago: 2,
    hour: 10,
    ...
    target_type: 'user',
    target_id: 'u-new-31',
    metadata: { email: 'newbie@initech.io', role: 'editor' },
  },
  {
    days_ago: 2,
    hour: 11,
  ...
  },
  {
    ...
    target_type: 'apikey',
    target_id: 'ak-202',
    metadata: { scope: 'write', prefix: 'pk_live_b201' },
  },
  {
    days_ago: 2,
    hour: 15,
    ...
    target_type: 'deck',
    target_id: 'd-002',
    metadata: { format: 'pptx', size_kb: 2210 },
  },
  ...
  },
  {
    ...
    target_type: 'sso-provider',
    target_id: 'sso-azure-stark',
    metadata: { ok: true, latency_ms: 388 },
  },
  {
    days_ago: 3,
    hour: 9,
  ...
  },
  {
    ...
    action: 'dlp.rule.added',
    target_type: 'dlp-rule',
    target_id: 'dlp-profanity',
    metadata: { kind: 'dictionary', dictionary: 'profanity_en' },
  },
  {
    days_ago: 3,
    hour: 10,
    ...
    target_type: 'user',
    target_id: 'u-old-44',
    metadata: { email: 'departed@initech.io', reason: 'offboarded' },
  },
  {
    days_ago: 3,
    hour: 11,
  ...
  },
  {
    ...
    target_type: 'sso-provider',
    target_id: 'sso-legacy-okta',
    metadata: { reason: 'tenant_migration' },
  },
  {
    days_ago: 3,
    hour: 16,
  ...
  },
  {
    ...
    target_id: 'dlp-profanity',
    diff: {
      before: { enabled: true, actions: ['notify'] },
      after: { enabled: true, actions: ['block-share', 'notify'] },
    },
  },
  {
    days_ago: 4,
  ...
  },
  {
    ...
    target_type: 'sso-provider',
    target_id: 'sso-azure-stark',
    metadata: { ok: true, latency_ms: 401 },
  },
  ...
  },
  {
    ...
    target_type: 'plugin',
    target_id: 'pln-table-plus',
    metadata: { reason: 'security_advisory' },
  },
  {
    days_ago: 5,
    hour: 9,
  ...
  },
  {
    ...
    target_type: 'sso-provider',
    target_id: 'sso-azure-stark',
    metadata: { ok: false, error: 'clock_skew' },
  },
  {
    days_ago: 6,
    hour: 13,
  ...
  },
  {
    ...
    target_type: 'dlp-rule',
    target_id: 'dlp-passport',
    diff: { before: { enabled: true }, after: { enabled: false } },
  },
  {
    days_ago: 7,
    hour: 10,
    ...
    target_type: 'user',
    target_id: 'u-new-31',
    diff: { before: { role: 'editor' }, after: { role: 'admin' } },
  },
  {
    days_ago: 7,
    hour: 11,
  ...
  },
  {
    ...
    target_type: 'sso-provider',
    target_id: 'sso-azure-stark',
    metadata: { ok: true, latency_ms: 376 },
  },
  ...
  },
  {
    ...
    target_type: 'dlp-rule',
    target_id: 'dlp-bank-iban',
    diff: { before: { scopes: ['slide-content'] }, after: { scopes: ['slide-content', 'asset'] } },
  },
  {
    days_ago: 10,
    hour: 10,
...
function toCsvCell(
  event: AuditEvent,
  key: 'timestamp' | 'actor_email' | 'action' | 'target_type' | 'target_id' | 'trace_id',
): string {
  switch (key) {
    case 'timestamp':
...
export async function exportAuditEventsCSV(filter: AuditFilter = {}): Promise<string> {
  ...
  const headers: ReadonlyArray<
    'timestamp' | 'actor_email' | 'action' | 'target_type' | 'target_id' | 'trace_id'
  > = ['timestamp', 'actor_email', 'action', 'target_type', 'target_id', 'trace_id'];
  const lines: string[] = [];
