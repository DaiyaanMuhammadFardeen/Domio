...
import type { Webhook, WebhookDelivery, WebhookEventType, WebhookInput } from '../../lib/types';
...
export default function WebhooksPage() {
  ...
  return (
    <div data-testid="webhooks-page" className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            <FormattedMessage id="admin.webhooks.subheading" catalogue={CATALOGUE} />
          </p>
        </div>
        <button
          type="button"
        ...
        >
          ...
          <FormattedMessage id="admin.webhooks.newWebhook" catalogue={CATALOGUE} />
        </button>
      </div>
      ...
      <div className="flex flex-wrap gap-1 border-b border-slate-200" data-testid="webhooks-tabs">
        {TABS.map((t) => {
          ...
          return (
            ...
            >
              {t.key === 'subscriptions' ? (
                <FormattedMessage id="admin.webhooks.tab.subscriptions" catalogue={CATALOGUE} />
              ) : (
                <FormattedMessage id="admin.webhooks.tab.tester" catalogue={CATALOGUE} />
              )}
            </button>
          );
        })}
              ...
              <div className="space-y-4">
                ...
                <fieldset>
                  <legend className="block text-xs font-medium uppercase tracking-wide text-slate-500">
                    <FormattedMessage id="admin.webhooks.col.events" catalogue={CATALOGUE} />
                  </legend>
                  <div
                ...
                <table className="min-w-full divide-y divide-slate-200 text-sm">
                  <thead className="bg-slate-50">
                    <tr>
                      ...
                      <th className="px-4 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-600">
                        <FormattedMessage id="admin.webhooks.col.enabled" catalogue={CATALOGUE} />
                      </th>
