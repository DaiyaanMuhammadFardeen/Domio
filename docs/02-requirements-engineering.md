...
> **Status:** Canonical FR/NFR list for engineering. Feature-domain docs (under `docs/`) own design details; this document owns *what must be true*. Backed by `feature-list.md` (the source list of 240 features). Every FR ID and NFR ID is stable; new IDs prepend, never reuse.
> **Assumptions:**
...
> **Source of truth:** this document is the canonical FR/NFR list for engineering. Feature-domain docs (`docs/editor-canvas.md`, `docs/live-data-charts.md`, etc.) own *design* details; this document owns *what must be true*.
