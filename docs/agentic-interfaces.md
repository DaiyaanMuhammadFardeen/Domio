    ...
    - id: churn
      elements:
        - id: churn_by_region
          role: chart
          type: bar
          data_binding: { source: gsheet:1abc..., query: "select region, sum(churn)..." }
...
```json
{
  ...
  "engine_version": "sdk-1.4.0",
  "results": [
    { "params": {"discount": 0.1, "volume": 2500}, "outputs": {"revenue": 1234567} }
  ],
  "deterministic": true
}
```
