...
| `@domio/auth` _(inherited)_          | avail-auth                    | 99.9%    | 30d    | tier-1 | Cross-cutting (SEC)  | `SLOBurnHighAuth`                   |
| `@domio/auth` _(inherited)_          | lat-auth-p95                  | < 300 ms | 30d    | tier-1 | Cross-cutting (SEC)  | `SLOBurnHighAuthLat`                |
| `@domio/billing` _(P22 stretch)_     | avail-billing                 | 99.9%    | 30d    | tier-1 | FIN                  | `SLOBurnHighBilling`                |
...
| `@domio/component` _(packages)_      | avail-component-registry      | 99.9%    | 30d    | tier-1 | A                    | `SLOBurnHighComponents`             |
